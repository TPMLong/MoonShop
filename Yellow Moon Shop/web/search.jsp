            ...
            <c:if test="${not empty result}">
                            ...
                            <div class="col mb-4">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="cake" value="${dto.productID}" />                
                                        Order cake:
                                        <input type="number" value="1" name="quantityOrder"><br/>
                ...
                <div id="myDIV">
                    <div class="btn-group" role="group" aria-label="Basic example">
                        <c:forEach var="dto" begin="0" end="${requestScope.PAGE}" step="1"  varStatus="counter">   
                            <form action="page" method="POST">
                                <button type="submit" class="btn btn-secondary" >${counter.count}</button>
                                <input type="hidden" name="btnPage" value="${counter.count}" />
                            </form>               
                        </c:forEach>
                    </div>
                </c:if>  

...
private final String SHOW_PAGE = "cartShow";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String cakes = request.getParameter("updateCart");
        ...
        try {
            ...
            if(dao.checkQuantityCart(cakes, quantity) ==  true){               
                cart.updateQuantity(cakes, quantity);
                session.removeAttribute("ERROR");
            }else{
                String error = "Out of order or order cake < 0";
